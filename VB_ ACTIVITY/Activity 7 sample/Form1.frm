...
Begin VB.Form Form1 
   ...
   Begin VB.CommandButton cmdLeft 
      ...
      Width           =   2295
   End
   Begin VB.CommandButton cmdIntsrev 
      Caption         =   "StrReverse"
      Height          =   495
      Left            =   8160
      TabIndex        =   13
...
MsgBox InStr(1, txtinput, "P")
End Sub

Private Sub cmdIntsrev_Click()
MsgBox StrReverse(txtinput)
End Sub

Private Sub cmdLeft_Click()
MsgBox Left(txtinput, InStr(1, txtinput, "P"))
End Sub

Private Sub cmdright_Click()
MsgBox Right(txtinput, InStr(1, txtinput, "P"))
End Sub
