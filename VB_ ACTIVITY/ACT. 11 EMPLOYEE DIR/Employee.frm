...
'   txtTel = Mid(fgEmpl.TextMatrix(fgEmpl.rowsel, 5), 1, 8)
'   txtCell = Mid(fgEmpl.TextMatrix(fgEmpl.rowsel, 5), 11, 12)
...
txtCell = ""
txtTel = ""
txtId = "0000" & fgEmpl.TextMatrix(fgEmpl.Rows - 1, 0) + 1
End Sub
